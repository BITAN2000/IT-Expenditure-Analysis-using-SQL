...
2. Variance Analysis — Key Insights Extracted

You compute variance between:

Actual vs Forecast → measures operational deviations

Actual vs Plan → measures budget deviation
...
4. What This Entire Analysis Provides
...
✔ Identifies cost leakages and overspend areas
